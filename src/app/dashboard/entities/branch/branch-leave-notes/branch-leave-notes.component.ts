...
export interface LeaveNote {
  ...
  const leaves: LeaveNote[] = [
    ...
    { id: "19-9th-004", class: "9 (A Div)", studentName: "Shubha Bhatt", subject: "Dengue", description: "A temporary increase in average body temperature of 98.6°F (37°C).", leaveFrom: "5/1/2019", leaveTo: "15/1/2019", attatchment: [{ id: "Attatchment one" }, { id: "Attatchment two" }], status: "Denied" },
    { id: "19-9th-005", class: "9 (A Div)", studentName: "Tarun Patel", subject: "Dengue", description: "A temporary increase in average body temperature of 98.6°F (37°C).", leaveFrom: "7/1/2019", leaveTo: "12/1/2019", attatchment: [{ id: "Attatchment one" }, { id: "Attatchment two" }], status: "Pending" },
    { id: "19-9th-006", class: "9 (A Div)", studentName: "Aakash Bhavasar", subject: "Fever", description: "A temporary increase in average body temperature of 98.6°F (37°C).", leaveFrom: "12/1/2019", leaveTo: "22/1/2019", attatchment: [{ id: "Attatchment one" }, { id: "Attatchment two" }], status: "Pending" },
    { id: "19-9th-007", class: "9 (A Div)", studentName: "Harshil Sureja", subject: "Cold", description: "A temporary increase in average body temperature of 98.6°F (37°C).", leaveFrom: "15/1/2019", leaveTo: "30/1/2019", attatchment: [{ id: "Attatchment one" }, { id: "Attatchment two" }], status: "Denied" },
    { id: "19-9th-008", class: "9 (A Div)", studentName: "Saurabh Oza", subject: "Cold", description: "A temporary increase in average body temperature of 98.6°F (37°C).", leaveFrom: "1/2/2019", leaveTo: "5/2/2019", attatchment: [{ id: "Attatchment one" }, { id: "Attatchment two" }], status: "Approved" },
    { id: "19-9th-009", class: "9 (A Div)", studentName: "Hastik Bhut", subject: "DenguFevere", description: "A temporary increase in average body temperature of 98.6°F (37°C).", leaveFrom: "4/2/2019", leaveTo: "8/2/2019", attatchment: [{ id: "Attatchment one" }, { id: "Attatchment two" }], status: "Approved" },
    { id: "19-9th-010", class: "9 (A Div)", studentName: "Yash Charola", subject: "Fever", description: "A temporary increase in average body temperature of 98.6°F (37°C).", leaveFrom: "12/2/2019", leaveTo: "22/2/2019", attatchment: [{ id: "Attatchment one" }, { id: "Attatchment two" }], status: "Approved" },
  ]
